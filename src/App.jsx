...
const FamilyMembers = lazyRetry(() => import('./pages/FamilyMembers'));
const CrisisClaim = lazyRetry(() => import('./pages/CrisisClaim'));
const Benefits = lazyRetry(() => import('./pages/Benefits'));
...
const AgentApp = lazyRetry(() => import('./pages/AgentApp'));
const MasterDashboard = lazyRetry(() => import('./pages/MasterDashboard'));
const SuperMasterDashboard = lazyRetry(() => import('./pages/SuperMasterDashboard'));
const RegisterFee = lazyRetry(() => import('./pages/RegisterFee'));
const ShortRedirect = lazyRetry(() => import('./pages/ShortRedirect'));
const RecruitmentLogin = lazyRetry(() => import('./pages/RecruitmentLogin'));
const StandingOrderSetup = lazyRetry(() => import('./pages/StandingOrderSetup'));
